...
$(document).ready(function () {
  ...
  let caldoDeLenguaClick = $("#caldoDeLengua").click(function (food) {
    ...
    $(".items").append("<li class='.menuItem'><span> X </span>" + "Caldo de Lengua - " + caldoDeLenguaPrice + "</li>");
